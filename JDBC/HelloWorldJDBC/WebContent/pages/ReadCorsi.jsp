...
<html>
	<head>
		...
		<title>Read Corsi</title>
	</head>
	
	<body>
	<table border="1">
	<tr><td>idCorsi</td><td>descrizione</td><td>dataCreazione</td></tr>
	<%
	try{
		...
		while(rs.next())  
		out.println("<tr>"+"<td>"+rs.getInt(1)+"</td>"+"<td>"+rs.getString(2)+"</td>"+"<td>"+rs.getDate(3)+"</td>"+"</tr>"+"<br/>");  
		con.close();
